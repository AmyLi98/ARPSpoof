...
ArpRecvThread::ArpRecvThread(QObject *parent) : QThread(parent)
{

}
ArpRecvThread::ArpRecvThread(QString adapterName, QString ip){
...
void ArpRecvThread::run(){
    ...
    // arp[16:2]即目的以太网MAC地址 192.168.1.2本地局域网
    // http://www.ferrisxu.com/WinPcap/html/group__language.html 过滤串表达式语法解释
